...
class Onboardingscreen19 extends StatefulWidget {
  ...
  @override
  State<Onboardingscreen19> createState() => _Onboardingscreen19State();
}

class _Onboardingscreen19State extends State<Onboardingscreen19> {
  ...
  void initState() {
    ...
    selectedOption = _validationController.eatingTime.value;
  }
  @override
  ...
  Widget _buildOption(String text) {
    ...
    return GestureDetector(
      onTap: () {
        ...
        _validationController.eatingTime.value = text;
      },
      child: Container(
