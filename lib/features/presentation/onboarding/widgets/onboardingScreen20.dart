...
class Onboardingscreen20 extends StatefulWidget {
  ...
  @override
  State<Onboardingscreen20> createState() => _Onboardingscreen20State();
}

class _Onboardingscreen20State extends State<Onboardingscreen20> {
  ...
  void initState() {
    ...
    selectedOption = _validationController.mealPrepTime.value;
  }
  @override
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        /// OPTIONS
        _buildOption("Less than 10 minutes"),

        SizedBox(height: 1.7.h),

        _buildOption("10-20 minutes"),
        SizedBox(height: 1.7.h),
        _buildOption("20-30 minutes"),
        SizedBox(height: 1.7.h),
        _buildOption("More than 30 minutes"),
      ],
    );
  }
  ...
  Widget _buildOption(String text) {
    ...
    return GestureDetector(
      onTap: () {
        ...
        _validationController.mealPrepTime.value = text;
      },
      child: Container(
