...
class Onboardingscreen21 extends StatefulWidget {
  ...
  @override
  State<Onboardingscreen21> createState() => _Onboardingscreen21State();
}

class _Onboardingscreen21State extends State<Onboardingscreen21> {
  ...
  void initState() {
    ...
    selectedOption = _validationController.eatOutFrequency.value;
  }
  @override
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        /// OPTIONS
        _buildOption("Never or rarely (0-1x per week)"),

        SizedBox(height: 1.7.h),

        _buildOption("Occasionally (2-3x per week)"),
        SizedBox(height: 1.7.h),
        _buildOption("Regularly (4+ times per week)"),
      ],
    );
  }
  ...
  Widget _buildOption(String text) {
    ...
    return GestureDetector(
      onTap: () {
        ...
        _validationController.eatOutFrequency.value = text;
      },
      child: Container(
